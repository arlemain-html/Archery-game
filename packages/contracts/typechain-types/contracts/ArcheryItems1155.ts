...
export interface ArcheryItems1155Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export namespace ItemBurnedEvent {
  export type InputTuple = [
    from: AddressLike,
    id: BigNumberish,
    amount: BigNumberish
  ];
  export type OutputTuple = [from: string, id: bigint, amount: bigint];
  export interface OutputObject {
    from: string;
    id: bigint;
    amount: bigint;
...
export namespace ItemMintedEvent {
  ...
  export type OutputTuple = [to: string, id: bigint, amount: bigint];
  export interface OutputObject {
    to: string;
    id: bigint;
    amount: bigint;
...
export interface ArcheryItems1155 extends BaseContract {
  connect(runner?: ContractRunner | null): ArcheryItems1155;
  waitForDeployment(): Promise<this>;

  interface: ArcheryItems1155Interface;
  ...
  getEvent(
    ...
    ItemBurnedEvent.InputTuple,
    ItemBurnedEvent.OutputTuple,
    ItemBurnedEvent.OutputObject
  >;
  getEvent(
    key: "ItemMinted"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "ItemBurned(address,uint256,uint256)": TypedContractEvent<
      ItemBurnedEvent.InputTuple,
      ItemBurnedEvent.OutputTuple,
      ItemBurnedEvent.OutputObject
    >;
    ItemBurned: TypedContractEvent<
      ItemBurnedEvent.InputTuple,
      ItemBurnedEvent.OutputTuple,
      ItemBurnedEvent.OutputObject
    >;

    "ItemMinted(address,uint256,uint256)": TypedContractEvent<
      ItemMintedEvent.InputTuple,
      ItemMintedEvent.OutputTuple,
      ItemMintedEvent.OutputObject
    >;
